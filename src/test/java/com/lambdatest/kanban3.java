...
public class kanban3 {
    ...
    public void basicTest() {
        try
        {
            driver.get("https://lambdatest.com/support/docs");
    ...
    private String getPOSTApiResponse(String apiUrl, String requestBody) throws IOException {
        URL url = new URL(apiUrl);
        String apiKey= "e160dcb6a5d5899fd5079f6efcfc3e970cc9ea304b8a23dd859e0950db2f3c98f68e6126a9a4fc263900962972f9b11925895842099c8fe7e59768c11f7adc36311bb2cbd4e0737ec777aaa2a227aa21";
        HttpURLConnection connection = (HttpURLConnection) url.openConnection();
