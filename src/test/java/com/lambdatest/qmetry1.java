        ...
        try {
            if (driver != null) {
                ...
                for (int i = 0; i < linkedTestCasesResult.length(); i++) {
                    ...
                    String key = obj.getString("key");
                    System.out.println("----------LT SESSIONS API test name-----------" + userTestResultName);
                    if (userTestResultName.equals(key)) {
                        String id = obj.getString("testCaseExecutionId");
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    JSONObject executionResultResponseObj = jsonArray.getJSONObject(i);
